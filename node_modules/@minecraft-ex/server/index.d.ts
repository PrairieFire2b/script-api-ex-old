...
interface Entity extends server.Entity {
}
...
export var Entity: typeof server.Entity & EntityConstructor;
...
declare global {
    ...
    export function clearInterva(id: number): void;
    export function clearTimeout(id: number): void;
...
interface Player extends server.Player {
    ...
    readonly selectedItem: server.ItemStack;
}

interface PlayerConstructor {
    /**
     * Gets a player from a player-like object.
     */
    from(playerLike: server.Entity | string): Player;
    prototype: Player;
}

export var Player: typeof server.Player & PlayerConstructor;
